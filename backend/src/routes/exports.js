  ...
  try {
    ...
    const doc = new PDFDoc({
      ...
      info: {
        ...
        Author:   'StrataBio Stability Platform',
        Creator:  'StrataBio Stability Platform, powered by EnduraFAST',
      },
    });
    ...
    doc.fillColor('#ffffff').fontSize(16).font('Helvetica-Bold')
      .text('StrataBio Stability Platform', L + 12, Y + 8, { lineBreak: false });
    ...
    doc.fillColor('#9ca3af').fontSize(7).font('Helvetica')
      .text(
        `Generated by the StrataBio Stability Platform, powered by EnduraFAST · ${new Date().toISOString()} · Experiment ID: ${experiment._id}`,
