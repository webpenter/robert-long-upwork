  ...
  try {
    ...
    const doc = new PDFDoc({
      ...
      info: {
        ...
        Author:   'EnduraFAST by StrataBio',
        Creator:  'EnduraFAST by StrataBio',
      },
    });
    ...
    doc.fillColor('#ffffff').fontSize(16).font('Helvetica-Bold')
      .text('EnduraFAST by StrataBio', L + 12, Y + 8, { lineBreak: false });
    ...
    doc.fillColor('#9ca3af').fontSize(7).font('Helvetica')
      .text(
        `Generated by EnduraFAST (StrataBio) · ${new Date().toISOString()} · Experiment ID: ${experiment._id}`,
